...
class Predict:
    def __init__(self, parray, tarray, key):
        model1 = ["ST20A","ST20B", "ST30A", "ST30B", "ST40A", "ST40B", "ST50A", "ST50B", "ST60A", "ST60B", "ST71", "ST72", "ST91", "ST92"]
        ...
        if key in model1:
            ...
            self.model = tf.keras.models.load_model("./models/moditmodel2")
    def model_forecast(self, window_size):
        ...
        for _ in range(80):
            ...
            forecast = np.append(forecast, pval)
